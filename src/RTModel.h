...
class RTModel
{
	public:
		...
		static double indexConsecutivePolarResidues(const float* index, const string& peptide);
	    ...
	    static size_t minimumNumRTFeatures() {return 3*13+4;}
