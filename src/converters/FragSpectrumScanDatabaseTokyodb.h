...
public:
  ...
  FragSpectrumScanDatabaseTokyoDB(const FragSpectrumScanDatabase& original);

  FragSpectrumScanDatabaseTokyoDB();

  FragSpectrumScanDatabaseTokyoDB(const FragSpectrumScanDatabaseTokyoDB& other);

  virtual ~FragSpectrumScanDatabaseTokyoDB();

  virtual FragSpectrumScanDatabaseTokyoDB& operator=(const FragSpectrumScanDatabaseTokyoDB& other);

  virtual bool operator==(const FragSpectrumScanDatabaseTokyoDB& other) const;
  
  virtual bool FragSpectrumScanDatabaseTokyoDB::init(std::string fileName);
