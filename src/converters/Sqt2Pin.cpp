...
void Sqt2Pin::run() {
// TODO: MATTIA the program seems to require an output file that is not used!
// data is simply printed on cout and must be redirected at shell
// execution time as follows: sqt2pin file file > output
