 ...
 **
 ** @(#) $Id: sqlite3.h,v 1.1 2009/06/07 21:42:24 lukall Exp $
 */
#ifndef _SQLITE3_H_
#define _SQLITE3_H_
...
struct sqlite3_module {
    int iVersion;
    int
        (*xCreate)(sqlite3*, void* pAux, int argc,
                   const char* const * argv, sqlite3_vtab** ppVTab, char**);
    int (*xConnect)(sqlite3*, void* pAux, int argc,
 ...
 */
int sqlite3_db_status(sqlite3*, int op, int* pCur, int* pHiwtr,
                      int resetFlg);
