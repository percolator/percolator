...
/*	
  ...
  cout << "Scan #" << s.getScanNumber() << " has " << s.size()
      << " data points." << endl;
  ...
  cout << "The 5th spectrum in MSObject is scan #"
      << o.at(4).getScanNumber() << " and has " << o.at(4).size()
      << " data points." << endl;
  ...
  if (!r.readFile(NULL, true, tempSpec)) {
    cout << "Error reading scan" << endl;
  }
  ...
  cout << "Done!" << endl;
  //Check the 5th scan
  cout << "The 5th spectrum in the binary file is scan #"
      << o.at(4).getScanNumber() << " and has " << o.at(4).size()
      << " data points." << endl;
