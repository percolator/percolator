...
bool FidoInterface::initialize(Scores& peptideScores, const Enzyme* enzyme, std::string& protEstimatorDecoyPrefix) {  
  ...
  return ProteinProbEstimator::initialize(peptideScores, enzyme, protEstimatorDecoyPrefix);
}
