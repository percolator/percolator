...
class DescriptionOfCorrect {
  public:
    ...
    static void fillFeaturesAllIndex(const string& peptide,
                                     double *features);
    ...
    static size_t minimumNumRTFeatures() {
      return 3 * 10 + 1 + ptmAlphabet.length();
    }
  ...
  protected:
    ...
    static inline double indexSum(const float *index,
                                  const string& peptide);
    static inline double indexAvg(const float *index,
                                  const string& peptide);
    ...
    static inline double* indexPartialSum(const float* index,
                                          const string& peptide,
                                          const size_t window,
                                          double *features);
