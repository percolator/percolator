...
// Print out easy part of the header
    cout << "<HTML>\n";
    cout << "<HEAD><TITLE>HTML-SUMMARY</TITLE></HEAD>\n";
    cout << "<BODY BGCOLOR=\"#FFFFFF\">\n";
    cout << "<PRE><FONT COLOR=\"green\">";
    cout << "HTML-SUMMARY</FONT>\n";
    cout << "Institute for Systems Biology\n";
    cout << "Seattle, WA\n";
    cout << hdr.szDate << " ";
    cout << hdr.szTime.c_str() << " ";
    cout << hdr.szTimeSuffix << " ";
    cout << data.at(0).szDatabase << ", ";
    cout << hdr.szMassType << "\n";
    cout << "\n";
