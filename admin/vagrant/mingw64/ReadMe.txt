...
2. In build_ming.sh change the release value to desierd subfolder and change branch to the desierd branch. it is recommended to leave the other values as they are.
