...
if [ ! -d "xsd-3.3.0-x86_64-linux-gnu" ]; then
    ...
    wget http://codesynthesis.com/download/xsd/3.3/linux-gnu/i686/xsd-3.3.0-i686-linux-gnu.tar.bz2 
    #tar xfj xsd-3.3.0-x86_64-linux-gnu.tar.bz2
    tar xfj xsd-3.3.0-i686-linux-gnu.tar.bz2
    #rm xsd-3.3.0-x86_64-linux-gnu.tar.bz2
    rm xsd-3.3.0-i686-linux-gnu.tar.bz2
    # TODO: this renaming is needed by cmake... this might create confusion though!
    mv xsd-3.3.0-i686-linux-gnu xsd-3.3.0-x86_64-linux-gnu
fi
echo "STEP 1 DONE."
echo ""
