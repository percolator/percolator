...
os.popen("./sqt2pin -x data/percolator_test/pin.xml data/percolator_test/target.sqt " 
  + "data/percolator_test/reverse.sqt")
...
output = os.popen("./percolator data/percolator_test/pin.xml " + " 2>&1 | grep \"New pi_0 estimate\"")
