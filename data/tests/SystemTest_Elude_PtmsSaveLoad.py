...
def SaveLoadSamePtms():
  ...
  os.system("elude" + " -t " + train_file + " -e " + test_file + " -o " + out_file1
...
def SaveLoadDifferentPtms():
  ...
  # train and save the model
  os.system("elude" + " -t " + train_file + " -e " + test_file + " -s " 
...
def SaveLoadInconsistentPtms():
  ...
  # train and save the model
  os.system("elude" + " -t " + train_file + " -s " 
...
def SaveLoadIgnorePtms():
  ...
  # train and save the model
  os.system("elude" + " -t " + train_file + " -e " + test_file + " -s " + model_file 
