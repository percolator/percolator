...
IF (XDR_HAS_RPC_TYPES_H AND XDR_HAS_RPC_XDR_H)
  ...
  CHECK_FUNCTION_EXISTS(xdr_u_int XDR_INT_FOUND)
  CHECK_FUNCTION_EXISTS(xdr_bool XDR_INT_FOUND)
  CHECK_FUNCTION_EXISTS(xdr_double XDR_INT_FOUND)
  CHECK_FUNCTION_EXISTS(xdr_uint32_t XDR_INT_FOUND)
  CHECK_FUNCTION_EXISTS(xdr_int32_t XDR_INT_FOUND)
  CHECK_FUNCTION_EXISTS(xdr_opaque XDR_INT_FOUND)
